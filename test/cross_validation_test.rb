...
class CrossValidationTestSuite < MiniTest::Test
    ...
    def setup
        @sut = CrossValidation.new(PREFS, NUMBER_OF_FOLDS, seed: SEED)
    end

    def create_sut_with_empty_prefs
        @sut = CrossValidation.new(EMPTY_PREFS, NUMBER_OF_FOLDS, seed: SEED)
    end

    def create_sut_with_too_small_prefs
        @sut = CrossValidation.new(TOO_SMALL_PREFS, NUMBER_OF_FOLDS, seed: SEED)
    end

    def create_sut_with_0_folds
        @sut = CrossValidation.new(PREFS, 0, seed: SEED)
    end
    ...
    def test_cross_validation
        ...
        expected_chunks = [
            {:testing_set=>{4=>{2=>"b"}, 10=>{1=>"a", 2=>"b"}, 1=>{1=>"a", 2=>"b"}, 6=>{1=>"a", 2=>"b"}, 5=>{1=>"a", 2=>"b"}},
             :training_set=>{3=>{1=>"a", 2=>"b"}, 2=>{3=>"c"}, 8=>{1=>"a", 2=>"b"}, 7=>{1=>"a", 2=>"b"}, 9=>{1=>"a", 2=>"b"}}},
            {:testing_set=>{3=>{1=>"a", 2=>"b"}, 2=>{3=>"c"}, 8=>{1=>"a", 2=>"b"}, 7=>{1=>"a", 2=>"b"}, 9=>{1=>"a", 2=>"b"}},
             :training_set=>{4=>{2=>"b"}, 10=>{1=>"a", 2=>"b"}, 1=>{1=>"a", 2=>"b"}, 6=>{1=>"a", 2=>"b"}, 5=>{1=>"a", 2=>"b"}}}]
