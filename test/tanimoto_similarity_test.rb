...
class TanimotoSimilarityTestSuite < MiniTest::Test
    include TestHelper
    def setup
        @sut = TanimotoSimilarity.new(CRITICS)
    end
    ...
    def test_that_similarity_gives_correct_distance_between_two_random_users
        assert_in_delta 0.33333, @sut.calculate_similarity(EXISTING_USER_1, EXISTING_USER_2), 0.00001
        assert_in_delta 0.33333, @sut.calculate_similarity(EXISTING_USER_2, EXISTING_USER_1), 0.00001
    end
end
